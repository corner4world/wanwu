...
This skill includes pre-installed Chinese fonts for proper rendering of Chinese characters in PDFs. The following fonts are available:

- **Noto Serif CJK SC (宋体)** - Recommended for Chinese text
- **Times New Roman (新罗马)** - Recommended for English text and numbers
...
Before creating PDFs with Chinese text, register the fonts:

```python
# Run the font registration script
import sys
...
# 2. Uses 宋体 for Chinese text
# 3. Uses 新罗马 for English text and numbers
