...
【模型名称】请求示例中的model，如qwen3-vl-reranker-8b

【API Key】第一步中申请的API Key

【推理url】https://maas-api.ai-yuanjing.com/openapi/compatible-mode/v1

登录元景万悟，点击模型管理-模型导入-联通元景-模型类型Multimodal Embedding，依次填写模型名称、API Key、推理url

![image-20260401110618303](assets/image-20260401110618303.png)
