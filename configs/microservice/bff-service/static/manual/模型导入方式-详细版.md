...
![image-20260703093331237](assets/image-20260703093331237.png)
...
![image-20260717092926086](assets/image-20260717092926086.png)

【模型名称】模型列表中的model参数接入点ID，如：paddleocr-vl-0.9b，可通过支持模型列表，查看模型ID

【API Key】第一步中申请的API Key

【推理url】查看“API文档”

![image-20260717093108652](assets/image-20260717093108652.png)



登录元景万悟，点击模型管理-模型导入-百度千帆-模型类型OCR，依次填写模型名称、API Key、推理url

![image-20260717092811346](assets/image-20260717092811346.png)
...
更多详细教程，可移步：https://blog.csdn.net/qq_28295947/article/details/162525003?sharetype=blogdetail&sharerId=162525003&sharerefer=PC&sharesource=qq_28295947&spm=1011.2480.3001.8118
