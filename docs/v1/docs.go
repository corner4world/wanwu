...
const docTemplate = `{
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.GetDocByKnowledgeNameAndDocNameResp"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "response.GetDocByKnowledgeNameAndDocNameResp": {
            "type": "object",
            "properties": {
                "disable": {
                    "description": "禁用模式，默认false",
                    "type": "boolean"
                },
                "id": {
                    "description": "文档ID",
