...
type KnowledgePermission struct {
	...
	OrgId          string `gorm:"column:org_id;uniqueIndex:idx_knowledge_id_org_user,priority:2;index:idx_org_user,priority:1;type:varchar(64);not null;default:'';" json:"orgId"`
	UserId         string `gorm:"column:user_id;uniqueIndex:idx_knowledge_id_org_user,priority:3index:idx_org_user,priority:2;type:varchar(64);not null;default:'';" json:"userId"`
}
